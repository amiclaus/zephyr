...
enum adgm3121_type {
	ADGM3121_TYPE_ADGM3121,
	ADGM3121_TYPE_ADGM3053,
};
...
static int adgm3121_init(const struct device *dev)
{
	...
	if (cfg->type == ADGM3121_TYPE_ADGM3053) {
		k_msleep(ADGM3053_POWER_UP_TIME_MS);
	} else {
	...
	LOG_INF("ADGM%s initialized (%s mode)",
		cfg->type == ADGM3121_TYPE_ADGM3053 ? "3053" : "3121",
...
#define ADGM3121_SPI_DEFINE(inst, _type, _compat)			\
	static struct adgm3121_data adgm3121_data_##_compat##_##inst;	\
	static const struct adgm3121_config				\
		adgm3121_config_##_compat##_##inst = {			\
		.type = _type,						\
...
#define ADGM3121_GPIO_DEFINE(inst, _type, _compat)			\
	static struct adgm3121_data adgm3121_data_##_compat##_##inst;	\
	static const struct adgm3121_config				\
		adgm3121_config_##_compat##_##inst = {			\
		.type = _type,						\
...
DT_INST_FOREACH_STATUS_OKAY_VARGS(ADGM3121_SPI_DEFINE,
				   ADGM3121_TYPE_ADGM3121,
				   DT_DRV_COMPAT)
...
DT_INST_FOREACH_STATUS_OKAY_VARGS(ADGM3121_GPIO_DEFINE,
				   ADGM3121_TYPE_ADGM3121,
				   DT_DRV_COMPAT)

/* ADGM3053 GPIO mode */
#undef DT_DRV_COMPAT
#define DT_DRV_COMPAT adi_adgm3053_gpio
DT_INST_FOREACH_STATUS_OKAY_VARGS(ADGM3121_GPIO_DEFINE,
				   ADGM3121_TYPE_ADGM3053,
				   DT_DRV_COMPAT)

...
All the hardware features available on the MAX32655FTHR are supported by
Zephyr.
...
Once the USB calbe is connected to your host computer, then you can simply run the
